package com.sensiblemetrics.api.ws.document.uploader.property;
...
@Description("SensibleMetrics Document Uploader Web Service template configuration properties")
