...
public class WsEndpointConfigurerAdapter {
  ...
  /**
   * Returns {@link DefaultWsdl11Definition} by input {@link XsdSchema} and {@link
   * WsAddressingProperty.WsEndpoint} properties
   *
   ...
   */
  public DefaultWsdl11Definition createWsdl11Definition(
      final XsdSchema xsdSchema, final WsAddressingProperty.WsEndpoint endpoint) {
   ...
   */
  public MessageDispatcherServlet createMessageDispatcherServlet(
