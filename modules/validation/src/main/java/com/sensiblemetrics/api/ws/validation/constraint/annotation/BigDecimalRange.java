...
import com.sensiblemetrics.api.ws.validation.constraint.validator.BigDecimalRangeValidator;
...
public @interface BigDecimalRange {
     ...
     */
    String message() default "{com.sensiblemetrics.api.ws.validation.constraint.annotation.BigDecimalRange.message}";
