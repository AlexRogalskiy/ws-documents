package com.sensiblemetrics.api.ws.webdocs.security.handler;
...
public class DelegatedEncryptablePropertyResolver implements EncryptablePropertyResolver {
  private static final String DEFAULT_PREFIX = "{cipher}";

  private final String prefix;
  private final PooledPBEStringEncryptor encryptor;

  public DelegatedEncryptablePropertyResolver(
      final String prefix, final SimpleStringPBEConfig config) {
