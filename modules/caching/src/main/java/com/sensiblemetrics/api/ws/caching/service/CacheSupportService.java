...
public class CacheSupportService {
   ...
   * @return {@link V} value
   */
  public <K, V> V getFromCache(final Cache cache, final K key) {
   ...
   */
  public <K, V> boolean putCache(final Cache cache, final K key, final V value) {
   ...
   * @return {@link Cache}
   */
  public <K> boolean evictFromCache(final Cache cache, final K key) {
