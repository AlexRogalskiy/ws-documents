package com.sensiblemetrics.api.ws.commons.aspect;

import com.sensiblemetrics.api.ws.commons.annotation.TrackingTime;
...
public class TrackingTimeAspect {
     ...
     */
    public static final String PROPERTY_PREFIX = WsLoggingProperty.Handlers.PROPERTY_PREFIX + PROPERTY_DELIMITER + "log-tracking-time";
    ...
    public Object around(final ProceedingJoinPoint joinPoint, final TrackingTime annotation) throws Throwable {
