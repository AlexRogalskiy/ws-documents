...
import static com.sensiblemetrics.api.ws.commons.enumeration.ErrorTemplateType.DOCUMENT_PROCESSING_ERROR;
...
public class DocumentProcessingException extends RuntimeException {
    ...
    /**
     * {@link DocumentProcessingException} constructor with initial input {@link String} message and {@link Throwable} target
     *
     * @param message - initial input message {@link String}
     * @param cause   - initial input target {@link Throwable}
     */
     ...
     */
    @NonNull
    public static DocumentProcessingException throwDocumentProcessingError(@Nullable final Object... args) {
        return throwDocumentProcessingErrorWith(DOCUMENT_PROCESSING_ERROR.getErrorMessage(), args);
    }
     ...
     */
    @NonNull
    public static DocumentProcessingException throwDocumentProcessingErrorWith(final String messageId,
