...
import com.sensiblemetrics.api.ws.commons.annotation.LoggingInfo;
...
public class LoggingAspect {
     ...
     */
    public static final String PROPERTY_PREFIX = WsLoggingProperty.Handlers.PROPERTY_PREFIX + PROPERTY_DELIMITER + "log-data";
