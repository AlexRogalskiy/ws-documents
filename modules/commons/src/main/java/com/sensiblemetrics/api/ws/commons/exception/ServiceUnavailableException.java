...
public class ServiceUnavailableException extends RuntimeException {
     ...
     */
    @NonNull
    public static ServiceUnavailableException throwServiceUnavailable(@Nullable final Object... args) {
     ...
     */
    @NonNull
    public static ServiceUnavailableException throwServiceUnavailableWith(final String messageId,
