...
import com.sensiblemetrics.api.ws.commons.general.annotation.SimpleTest;
import com.sensiblemetrics.api.ws.commons.general.annotation.VariableSource;
import com.sensiblemetrics.api.ws.commons.general.configuration.TestTag;
...
class ErrorTemplateTypeTest {
    ...
    private static Stream<Arguments> testCheckErrorTemplateTypeByFormattedString() {
        return Stream.of(
            ...
            Arguments.of(ErrorTemplateType.DOCUMENT_PROCESSING_ERROR, equalTo(getFormattedString("error-0060", "error.document.processing.invalid"))),
