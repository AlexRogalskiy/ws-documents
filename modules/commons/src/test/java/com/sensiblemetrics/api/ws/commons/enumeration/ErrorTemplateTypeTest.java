...
import com.sensiblemetrics.api.ws.commons.common.annotation.SimpleTest;
import com.sensiblemetrics.api.ws.commons.common.annotation.VariableSource;
import com.sensiblemetrics.api.ws.commons.common.configuration.TestTag;
...
class ErrorTemplateTypeTest {
  ...
  private static final Stream<Arguments> errorTemplateTypeValues =
      Stream.of(
          Arguments.of(
              SERVICE_UNAVAILABLE, createTypeMatcher("error-0030", "error.service.unavailable")),
          Arguments.of(
              SERVICE_OPERATION_ERROR, createTypeMatcher("error-0040", "error.operation.invalid")),
  ...
  private static Stream<Arguments> testCheckErrorTemplateTypeByValue() {
    return Stream.of(
        ...
        Arguments.of(
            "INVALID_ENDPOINT_SECURITY_CONFIGURATION",
            equalTo(INVALID_ENDPOINT_SECURITY_CONFIGURATION)));
  }
