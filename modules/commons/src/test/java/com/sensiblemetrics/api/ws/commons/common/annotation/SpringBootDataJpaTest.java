...
public @interface SpringBootDataJpaTest {
    ...
    DirtiesContext.ClassMode activeClassMode() default DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD;
    ...
    SpringBootTest.WebEnvironment activeEnvironmentMode() default SpringBootTest.WebEnvironment.RANDOM_PORT;
