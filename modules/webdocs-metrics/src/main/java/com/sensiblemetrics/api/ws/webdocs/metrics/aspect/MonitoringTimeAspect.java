...
public class MonitoringTimeAspect {
  ...
  @Pointcut(
      "@annotation(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredComponent) "
          + "|| @within(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredComponent)")
  public void monitoredComponentPointcut() {}

  @Pointcut(
      "@annotation(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredService) "
          + "|| @within(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredService)")
  public void monitoredServicePointcut() {}

  @Pointcut(
      "@annotation(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredRepository) "
          + "|| @within(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredRepository)")
  public void monitoredRepositoryPointcut() {}

  @Pointcut(
      "(@annotation(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredComponent) ||"
          + " @within(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredComponent))||"
          + " (@annotation(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredRestController)"
          + " || @within(com.sensiblemetrics.api.ws.webdocs.metrics.annotation.MonitoredRestController))")
