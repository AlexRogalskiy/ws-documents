package com.sensiblemetrics.api.ws.webdocs.metrics.property;
...
public class WsMetricsProperty {
  ...
  public static final String PROPERTY_PREFIX =
      DEFAULT_PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "metrics";
  /** Default {@link List} of {@link String} simple common tags */
  private static final List<String> DEFAULT_SIMPLE_COMMON_TAGS =
      Lists.newArrayList("scope", "webdocs");
  ...
  public static class MeterProperty {
    /** Default metrics property prefix */
    public static final String METER_PROPERTY_PREFIX =
        PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "meters";
  ...
  public static class Patterns {
    ...
    public static final String PROPERTY_PREFIX =
        WsMetricsProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "patterns";
  ...
  public static class Handlers {
    /** Default handlers property prefix */
    public static final String PROPERTY_PREFIX =
        WsMetricsProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "handlers";

    public static final String TRACKING_TIME_PROPERTY_PREFIX =
        PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "tracking-time";
    public static final String MONITORING_TIME_PROPERTY_PREFIX =
        PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "monitoring-time";
    public static final String HEALTH_STATUS_EXPORTER_PROPERTY_PREFIX =
        PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "health-status-exporter";
