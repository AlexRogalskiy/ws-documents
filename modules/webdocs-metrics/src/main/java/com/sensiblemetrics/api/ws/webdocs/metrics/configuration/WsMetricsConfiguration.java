package com.sensiblemetrics.api.ws.webdocs.metrics.configuration;

import com.sensiblemetrics.api.ws.webdocs.commons.helper.OptionalConsumer;
import com.sensiblemetrics.api.ws.webdocs.metrics.aspect.MonitoringTimeAspect;
import com.sensiblemetrics.api.ws.webdocs.metrics.aspect.TrackingTimeAspect;
import com.sensiblemetrics.api.ws.webdocs.metrics.meter.DataSourceStatusMeterBinder;
import com.sensiblemetrics.api.ws.webdocs.metrics.property.WsMetricsProperty;
...
@ConditionalOnProperty(
    prefix = WsMetricsProperty.PROPERTY_PREFIX,
    value = "enabled",
    havingValue = "true",
    matchIfMissing = true)
...
public abstract class WsMetricsConfiguration {
  ...
  public static final String METER_REGISTRY_COMMON_TAGS_CUSTOMIZER_BEAN_NAME =
      "metricsCommonTagsCustomizer";
  public static final String METER_REGISTRY_NAMING_CONVENTION_CUSTOMIZER_BEAN_NAME =
      "namingConventionCustomizer";
  public static final String METER_REGISTRY_WEB_MVC_TAGS_CONTRIBUTOR_BEAN_NAME =
      "webMvcTagsContributor";
  public static final String METER_REGISTRY_DATASOURCE_METER_PROBE_BEAN_NAME =
      "dataSourceStatusProbe";
  public static final String METER_REGISTRY_TIMED_ASPECT_BEAN_NAME = "timedAspect";
  public static final String METER_REGISTRY_MONITORING_TIME_ASPECT_BEAN_NAME =
      "monitoringTimeAspect";
  ...
  public MeterRegistryCustomizer<MeterRegistry> metricsNamingConventionCustomizer(
  ...
  public MeterRegistryCustomizer<MeterRegistry> metricsCommonTagsCustomizer(
      final WsMetricsProperty metricsProperty) {
    return registry ->
        OptionalConsumer.of(metricsProperty.getDefaults().getTags())
            .ifPresent(value -> registry.config().commonTags(value))
            .ifNotPresent(
                () ->
                    registry
                        .config()
                        .commonTags(metricsProperty.getDefaults().getSimpleTagsAsArray()));
  }
  ...
  @ConditionalOnProperty(
      prefix = WsMetricsProperty.Handlers.MONITORING_TIME_PROPERTY_PREFIX,
      value = "enabled",
      havingValue = "true")
  ...
  @ConditionalOnProperty(
      prefix = WsMetricsProperty.Handlers.TRACKING_TIME_PROPERTY_PREFIX,
      value = "enabled",
      havingValue = "true")
  ...
  public MeterFilter includeMeterFilter(
      final WsMetricsConfigurerAdapter configurerAdapter, final WsMetricsProperty metricsProperty) {
    return MeterFilter.accept(
        configurerAdapter.createMeterTagPredicate(metricsProperty.getPatterns().getInclude()));
  }
  ...
  public MeterFilter excludeMeterFilter(
    ...
    return MeterFilter.deny(
        configurerAdapter.createMeterTagPredicate(metricsProperty.getPatterns().getExclude()));
  }
  ...
  @ConditionalOnProperty(
      prefix = WsMetricsProperty.MeterProperty.METER_PROPERTY_PREFIX,
      name = "datasource")
  public Function<DataSource, DataSourceStatusMeterBinder> dataSourceStatusProbe(
      final WsMetricsProperty metricsProperty) {
    return dataSource -> {
      final WsMetricsProperty.MeterProperty meterProperty =
          metricsProperty.getMeters().get("datasource");
  ...
  public static class CustomWebMvcTagsContributor implements WebMvcTagsContributor {
    ...
    /**
     * Provides tags to be associated with metrics for the given {@code request} and {@code
     * response} exchange.
     *
     * @param request the request
     * @param response the response
     * @param handler the handler for the request or {@code null} if the handler is unknown
    ...
    /**
     * Returns {@link Function} mapper of {@link Stream} of {@link Map.Entry} to {@link List} of
     * {@link Tag}s
     *
