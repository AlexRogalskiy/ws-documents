...
public interface EndpointConfigurationProvider {
    /**
     * Returns {@link WsAddressingProperty.WsEndpoint} configuration by input {@link String} endpoint name
     *
    ...
    /**
     * Returns {@link WsAddressingProperty.WsEndpoint} configuration by input {@link String} endpoint name or throw {@link EndpointConfigurationException}
     *
     * @param endpointName initial input {@link String} endpoint name to fetch by
     * @return {@link WsAddressingProperty.WsEndpoint} configuration
