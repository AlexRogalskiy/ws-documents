...
@Description("SensibleMetrics WebDocs Graceful Shutdown configuration properties")
public class WsGracefulShutdownProperty {
    /**
     * Default graceful shutdown property prefix
     */
    public static final String PROPERTY_PREFIX = WsApiStatusProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "shutdown";
