...
class SpringBootTypeExcludeFilter
    extends StandardAnnotationCustomizableTypeExcludeFilter<EnableSpringBootTest> {
  ...
  SpringBootTypeExcludeFilter(final Class<?> testClass) {
    ...
    this.components =
        getAnnotation()
            .getValue(ACTIVE_CLASSES_ATTRIBUTE_NAME, Class[].class)
