...
public class SecurityConfigurationException extends RuntimeException {
   ...
   * @return {@link SecurityConfigurationException}
   */
  public static SecurityConfigurationException throwInvalidSecurityConfiguration(
      final Object target) {
    throw throwInvalidSecurityConfigurationWith(
        ErrorTemplateType.INVALID_ENDPOINT_SECURITY_CONFIGURATION.getErrorMessage(), target);
  }
   ...
   * @return {@link SecurityConfigurationException}
   */
  public static SecurityConfigurationException throwInvalidSecurityConfigurationWith(
