...
public class MessageSourceHelper implements MessageSourceAware {
  ...
  /**
   * Returns localized {@link String} message by input {@link String} message key, array of {@link
   * Object} arguments and {@link Locale}
   *
  ...
  public static String getMessage(
      final String messageKey, @Nullable final Object[] arguments, final Locale locale) {
    return messageSource.getMessage(messageKey, arguments, locale);
  }

  /**
   * Returns localized {@link String} message by input {@link String} message key, array of {@link
   * Object} arguments and default {@link Locale}
   *
   * @param messageKey - initial input {@link String} message key
   * @param arguments - initial input array of {@link Object} arguments
   * @return localized {@link String} message
  ...
  /**
   * Returns localized {@link String} message by input {@link ErrorTemplateType} and array of {@link
   * Object} arguments
   *
   ...
   */
  public static String getMessage(
      final ErrorTemplateType messageTemplate, @Nullable final Object... arguments) {
