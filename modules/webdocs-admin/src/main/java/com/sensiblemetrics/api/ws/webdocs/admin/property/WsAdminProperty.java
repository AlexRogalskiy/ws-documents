package com.sensiblemetrics.api.ws.webdocs.admin.property;
...
public class WsAdminProperty {
  ...
  public static final String PROPERTY_PREFIX =
      DEFAULT_PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "admin";
  ...
  public static class Handlers {
    ...
    public static final String PROPERTY_PREFIX =
        WsAdminProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "handlers";

    public static final String NOTIFICATION_PROPERTY_PREFIX =
        PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "notification";
