...
import com.sensiblemetrics.api.ws.webdocs.document.generator.model.entity.BaseAuditEntity;
import com.sensiblemetrics.api.ws.webdocs.document.generator.repository.BaseRepository;
import com.sensiblemetrics.api.ws.webdocs.document.generator.service.interfaces.BaseService;
import com.sensiblemetrics.api.ws.webdocs.document.generator.service.interfaces.RepositoryAware;
...
import static com.sensiblemetrics.api.ws.webdocs.commons.utils.ServiceUtils.copyNonNullProperties;
...
public abstract class BaseServiceImpl<E, ID extends Serializable>
    implements BaseService<E, ID>, RepositoryAware<E, ID> {
  ...
  public Optional<E> findById(final ID id) {
    ...
    return Optional.ofNullable(id).flatMap(this.getRepository()::findById);
  }
  ...
  public E deleteById(final ID id) {
    ...
    return this.findById(id).map(this::delete).orElseThrow(() -> throwResourceNotFound(id));
  }
