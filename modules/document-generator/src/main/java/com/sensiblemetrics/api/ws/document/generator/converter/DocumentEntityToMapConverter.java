package com.sensiblemetrics.api.ws.document.generator.converter;
...
public class DocumentEntityToMapConverter implements Converter<DocumentEntity, Map<String, String>> {
    ...
    public Map<String, String> convert(@NonNull final DocumentEntity source) {
        ...
        final String docPartnerFormat = this.format(source.getPartner(), mappings.getPartner().getPattern());
        final String docProductFormat = this.format(source.getProduct(), mappings.getProduct().getPattern());
        ...
        final String docDateFormat = this.formatDate(source.getCreatedDate().orElse(Instant.now()), mappings.getDate().getPattern());
        final String docTotalFormat = this.formatPrice(source.getPrice().multiply(BigDecimal.valueOf(source.getAmount())));
