...
@ConfigurationProperties(prefix = WsDocumentTemplateFormatProperty.PROPERTY_PREFIX, ignoreInvalidFields = true)
@Role(BeanDefinition.ROLE_INFRASTRUCTURE)
@Description("SensibleMetrics Document Generator Web Service Document Template Format configuration properties")
public class WsDocumentTemplateFormatProperty {
    /**
     * Default document template format property prefix
     */
    public static final String PROPERTY_PREFIX = WsDocumentTemplateProperty.PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "format";
