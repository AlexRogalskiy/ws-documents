...
import static com.sensiblemetrics.api.ws.document.generator.endpoint.DocumentEndpoint.Info.*;
...
public class DocumentEndpoint {
    ...
    public static class Info {
         ...
         */
        static final String DOCUMENT_NAMESPACE_URI = "http://api.sensiblemetrics.com/ws/document-generator-web-service";
        /**
