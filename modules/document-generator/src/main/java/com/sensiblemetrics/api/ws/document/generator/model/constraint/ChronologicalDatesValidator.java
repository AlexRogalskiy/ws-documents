package com.sensiblemetrics.api.ws.document.generator.model.constraint;

import com.sensiblemetrics.api.ws.document.generator.model.entity.AuditEntity;
...
import static com.sensiblemetrics.api.ws.document.generator.model.utils.ConstraintUtils.validate;
...
public class ChronologicalDatesValidator implements ConstraintValidator<ChronologicalDates, AuditEntity<?>> {
    ...
    public boolean isValid(final AuditEntity<?> auditEntity,
        ...
        return Optional.ofNullable(auditEntity)
                .map(value -> validate(this.datesExistPredicate, value, this.message, context)
