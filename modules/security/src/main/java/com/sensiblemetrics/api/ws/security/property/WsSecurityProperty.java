...
@Description("SensibleMetrics WebDocs Security configuration properties")
public class WsSecurityProperty {
    ...
    public static final String SSL_PROPERTY_PREFIX = PROPERTY_PREFIX + DEFAULT_PROPERTY_DELIMITER + "ssl";
