package com.sensiblemetrics.api.ws.webdocs.logger.aspect;

import com.sensiblemetrics.api.ws.webdocs.logger.annotation.LoggingInfo;
...
public class ReportingDataAspect {
  ...
  @Pointcut(
      "@annotation(com.sensiblemetrics.api.ws.webdocs.logger.annotation.LoggingInfo)"
          + "|| @within(com.sensiblemetrics.api.ws.webdocs.logger.annotation.LoggingInfo)")
