...
import com.sensiblemetrics.api.ws.webdocs.logger.annotation.EnableWsLogInterceptor;
...
public abstract class WsLoggingInterceptorConfiguration {
  ...
  private static final String TRACE_POINTCUT_EXECUTION_REPOSITORY =
      "execution(public * org.springframework.data.repository.Repository+.*(..))";
  /** Trace message formats */
  private static final String EXCEPTION_MESSAGE = "Exception thrown: " + PLACEHOLDER_EXCEPTION;

  private static final String EXIT_METHOD_MESSAGE =
      "Exiting method: "
          ...
          + " ms";
  private static final String ENTER_METHOD_MESSAGE =
      "Entering method: " + PLACEHOLDER_METHOD_NAME + "(" + PLACEHOLDER_ARGUMENTS + ")";
  ...
  public Advisor loggingTraceAdvisor(
      @Qualifier(LOGGING_TRACE_INTERCEPTOR_BEAN_NAME)
          final CustomizableTraceInterceptor loggingTraceInterceptor) {
