...
See the [Upgrading guide](https://github.com/AlexRogalsky/ws-documents/blob/master/UPGRADE.md).
...
- [ ] Search issues on the [repo](https://github.com/AlexRogalsky/ws-documents/) for a similar problems?
- [ ] Read the [README](https://github.com/AlexRogalsky/ws-documents/blob/master/README.md) carefully
...
2. Can you customize the styling or theme?  **A**: See [Customizing](https://github.com/AlexRogalskiy/ws-documents#customizing-fastpages)

See the [FAQ](https://github.com/AlexRogalskiy/ws-documents#faq) for frequently asked questions.
